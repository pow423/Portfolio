...
function generateAIResponse(userMessage) {
  ...
  const defaultResponses = [
    "That's an interesting question! 🤔 I'd love to help you learn more about Manikanta. You can ask me about his technical skills, amazing projects, professional experience, or how to get in touch with him. What interests you most?",

    "I'm here to help you discover Manikanta's expertise! 🌟 Whether you're curious about his React mastery, full-stack projects, 5+ years of experience, or want to discuss a potential collaboration - just let me know what you'd like to explore!",

    "Manikanta is always excited about new opportunities and connecting with fellow developers! 🚀 Feel free to ask about his technical skills, project portfolio, work experience, or check out his impressive work in the Projects section above!",

    "That's a great topic! 💡 While I focus on Manikanta's professional background, I can share insights about his development skills, career journey, project achievements, or availability for new work. What specific area would you like to dive into?",

    "I love your curiosity! 🎯 Manikanta has such a rich background in web development. Whether you want to know about his React expertise, full-stack projects, leadership experience, or how to collaborate with him - I'm here to help guide you!",
  ]
